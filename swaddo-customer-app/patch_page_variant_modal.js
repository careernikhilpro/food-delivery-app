...
const replacementModal = `const getVariantPrice = (vPrice) => {
...
if (code.match(regexModal)) {
  ...
  console.log('Successfully patched VariantModalComponent in page.tsx');
} else {
  console.log('Regex failed for VariantModalComponent in page.tsx');
}
