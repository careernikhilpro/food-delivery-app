...
export default function Cart() {
  ...
  useEffect(() => {
    if (baseItemTotal >= 199 && paymentMethod === "cod") {
      setPaymentMethod("upi");
    }
  }, [baseItemTotal, paymentMethod]);
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
          <div className="bg-white rounded-[24px] shadow-xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="p-4 bg-gray-50 flex gap-3">
              ...
              <button onClick={executeOrder} className="flex-1 py-3.5 bg-[#00A14F] text-white font-bold rounded-xl shadow-[0_4px_12px_rgba(0,161,79,0.25)] hover:bg-[#009146] transition-colors">
                Proceed
              </button>
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
          <div className="bg-white rounded-[24px] shadow-xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in duration-200 text-center">
            <div className="p-6">
              ...
              <div className="text-[42px] font-black text-[#00A14F] my-4 tracking-tight">
              ...
              <div className="flex gap-3">
                ...
                <button 
                  ...
                  className="flex-1 py-3.5 bg-[#00A14F] text-white font-bold rounded-xl shadow-[0_4px_12px_rgba(0,161,79,0.25)] hover:bg-[#009146] transition-colors"
                >
                  Confirm
                </button>
              </div>
