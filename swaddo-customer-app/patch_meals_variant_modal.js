...
if (code.match(regexModal)) {
  ...
  console.log('Successfully patched VariantModalComponent in meals-under-99/page.tsx');
} else {
  console.log('Regex failed for VariantModalComponent in meals-under-99/page.tsx');
}
