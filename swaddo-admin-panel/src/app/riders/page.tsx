          ...
          <div key={r.id} className=""bg-bg-alt/80 backdrop-blur-xl rounded-3xl p-6 shadow-sm border border-border-subtle hover:shadow-lg transition-all group"">
            ...
            <div className=""space-y-3 mt-6"">
              <div className=""flex items-center justify-between py-2 border-b border-border-subtle"">
                ...
                <span className={	ext-sm font-bold uppercase }>
                  {r.id_proof_status}
                </span>
              </div>
              <div className=""flex items-center justify-between py-2 border-b border-border-subtle"">
                ...
                <button 
                  ...
                  className={elative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none }
                >
              ...
              <div className=""flex items-center justify-between py-2"">
                ...
                <span className=""text-sm font-semibold text-text-primary"">
                  {r.isOnline && r.lat && r.lng ? (
                    <a href={https://maps.google.com/?q=,} target=""_blank"" rel=""noopener noreferrer"" className=""text-primary hover:underline flex items-center gap-1"">
                      View on Map
                    </a>
                  ) : (
